...
(function () {
  ...
  function FvttAbilities({ char, setChar, editMode }) {
    ...
    return (
      <div className="fvtt-sec">
        <h3><span className="h-title">Abilities</span> <span className="h-hint">{editMode ? "set scores — modifiers update live" : "roll-under d20"}</span></h3>
  ...
  function FvttFeatures({ char }) {
    return (
      <>
        <section className="fvtt-sec">
          <h3><span className="h-title">Class Features</span> <span className="h-hint">Magic-User</span></h3>
          <ul className="fvtt-features">
            <li><span className="fm">✦</span><span>Casts arcane spells from a memorised list; spells are forgotten once cast and must be re-memorised by rest &amp; study.</span></li>
            <li><span className="fm">✦</span><span>May read magical writings only after casting <i>Read Magic</i>.</span></li>
            <li><span className="fm">✦</span><span>Uses magic wands, rods, staves and most scrolls.</span></li>
            <li><span className="fm">✦</span><span>Weapons restricted to dagger; cannot wear any armour.</span></li>
          </ul>
        </section>
        <section className="fvtt-sec">
          <h3>Languages</h3>
