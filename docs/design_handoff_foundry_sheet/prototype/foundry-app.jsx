...
(function () {
  ...
  function App() {
    ...
    const [tab, setTab] = useState(t.tab || "actions");
          ...
          <div className="fvtt-window" style={winStyle}>
            ...
            <div className={`fvtt-body ${editMode ? "is-editing" : ""}`}>
                              ...
                              {editMode ? (
                                ...
                                <>
                                  ...
                                  <div className="vv-steps">
                                    <button onClick={() => adjustHp(-1)} title="Lose 1 HP">−</button>
                                    <button onClick={() => adjustHp(1)} title="Heal 1 HP">+</button>
                                  </div>
                                </>
                              )}
                            </div>
                    ...
                    <div className="fvtt-right">
                      <div className="fvtt-htabs" role="tablist">
                        {TABS.map(([id, label, ic, ct]) => (
                          <button key={id} className={`fvtt-htab ${tab === id ? "active" : ""}`} onClick={() => setTab(id)} role="tab" aria-selected={tab === id}>
                      ...
                      {tab === "inventory" && <FvttInventory char={char} setChar={setChar} />}
              ...
              <nav className="fvtt-tabrail">
                {TABS.map(([id, label, ic, ct]) => (
                  <button key={id} className={`fvtt-tab ${tab === id ? "active" : ""}`} onClick={() => setTab(id)} title={label}>
